"""
MOT -> Video renderer with optional muscle activation coloring.

Two modes:
  1. Basic skeleton video (default)
  2. Muscle activation video: muscles colored blue (inactive) -> red (active)
     using activations.csv from inverse dynamics output.

Usage:
  # Basic video
  python src/visualization/convert_mot2video.py model.xml file.mot output.mp4

  # Muscle activation video
  python src/visualization/convert_mot2video.py model.xml file.mot output.mp4 --activations id_dir/activations.csv
"""
import os
import sys
import mujoco
