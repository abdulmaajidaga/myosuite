...
DATA_DIR = os.path.join(BASE_DIR, "data/kinematic/cutoff/augmented")

MODEL_SAVE_PATH = os.path.join(BASE_DIR, "IK/cutoff/models/cvae_cutoff_fma.pth")
SCALER_SAVE_PATH = os.path.join(BASE_DIR, "IK/cutoff/models/scaler_cutoff_fma.pkl")
...
# --- 2. MODEL (Improved Architecture with Attention + BiLSTM + Residual) ---
